package atividades.atividadeRevisao.revisaoP1TipoC.model;
...
public class PostoCombustivel {
    ...
    public void analisarEstoque() {
        ...
        System.out.println("  " + tiposCombustivel[indiceMaior] + ":" + 
                          litrosDisponiveis[indiceMaior] + " litros");
        System.out.println("\nMENOR ESTOQUE:");
        System.out.println("  " + tiposCombustivel[indiceMenor] + ":" + 
                          litrosDisponiveis[indiceMenor] + " litros");
    }
